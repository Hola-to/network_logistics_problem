...
Микросервисная платформа для оптимизации сетевых потоков в логистике. Решает задачи максимального потока, минимальной стоимости и анализа узких мест в транспортных сетях.
