...
import (
	...
	context "context"
	errors "errors"
	v1 "logistics/gen/go/logistics/auth/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuthServiceName = "logistics.auth.v1.AuthService"
)
...
const (
	...
	AuthServiceLoginProcedure = "/logistics.auth.v1.AuthService/Login"
	// AuthServiceRegisterProcedure is the fully-qualified name of the AuthService's Register RPC.
	AuthServiceRegisterProcedure = "/logistics.auth.v1.AuthService/Register"
	// AuthServiceValidateTokenProcedure is the fully-qualified name of the AuthService's ValidateToken
	// RPC.
	AuthServiceValidateTokenProcedure = "/logistics.auth.v1.AuthService/ValidateToken"
	// AuthServiceRefreshTokenProcedure is the fully-qualified name of the AuthService's RefreshToken
	// RPC.
	AuthServiceRefreshTokenProcedure = "/logistics.auth.v1.AuthService/RefreshToken"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/logistics.auth.v1.AuthService/Logout"
)

// AuthServiceClient is a client for the logistics.auth.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the logistics.auth.v1.AuthService service. By
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_logistics_auth_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// Login calls logistics.auth.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// Register calls logistics.auth.v1.AuthService.Register.
...
// ValidateToken calls logistics.auth.v1.AuthService.ValidateToken.
...
// RefreshToken calls logistics.auth.v1.AuthService.RefreshToken.
...
// Logout calls logistics.auth.v1.AuthService.Logout.
...
// AuthServiceHandler is an implementation of the logistics.auth.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/logistics.auth.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logistics.auth.v1.AuthService.Login is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logistics.auth.v1.AuthService.Register is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ValidateToken(context.Context, *connect.Request[v1.ValidateTokenRequest]) (*connect.Response[v1.ValidateTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logistics.auth.v1.AuthService.ValidateToken is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshToken(context.Context, *connect.Request[v1.RefreshTokenRequest]) (*connect.Response[v1.RefreshTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logistics.auth.v1.AuthService.RefreshToken is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logistics.auth.v1.AuthService.Logout is not implemented"))
}
