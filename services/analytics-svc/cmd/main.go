...
func main() {
	cfg, err := config.LoadWithServiceDefaults("analytics-svc", 50053)
	if err != nil {
	...
	impl := service.NewAnalyticsService()
	analyticsv1.RegisterAnalyticsServiceServer(srv.GetEngine(), impl)
